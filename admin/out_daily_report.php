...
<tfoot>
    ...
    $today=date("Y/m/d");
    $select=mysqli_query($conn,"select * from `out_orders` o inner join `clients` c on o.client_id=c.client_unique where date(created_date)='$today'  order by out_order_id desc") or die(mysqli_error($conn));
