...
$to = 'nzimike2000@gmail.com,artnrwanda@gmail.com,hubert@itdevs.rw'; //$invitation["subscriber_email"];
$subject = 'One man comedy special invitation';

$headers = "From: Eguriro <".strip_tags("info@eguriro.com").">\r\n";
