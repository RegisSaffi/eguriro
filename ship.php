        ...
        <div class="container">
            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <h1 class="mb-0 bread">How it works</h1>
                    <p><span>This is a detailed process of how we deliver your desired product from across the globe to
                            you</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-6 col-sm-12">
                    <div class="text-element content-element circles-list2">
                        <ol>
                            <li>
                                <iframe width="450" height="300" src="https://www.youtube.com/embed/DfwWUuQHtRI"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                            </li>
                            <li>
                                <iframe width="450" height="300" src="https://www.youtube.com/embed/YVtR767wQa8"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                            </li>
                            ...
                            <li>
                                <iframe width="450" height="300" src="https://www.youtube.com/embed/GiRRSFl6PSk"
                                    frameborder="0"
                                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                            </li>
                    ...
                    <div class="text-element content-element circles-list">
                        <ol>
                            <li>
                                ...
                                <p>Please go to any of our partner stores and select any product you need, note that
                                    on
                                    the next
                                    step you will need item link and prices. if it is not clear you can follow the
                                    video.</p>

                                <a href="stores.php" class="btn-custom">View all stores</a>
                            </li>
                            <li>
                                <h3>Calculate Cost</h3>
                                <p>Open our cost calculator and insert all requested details and then click
                                    calculate
                                    button.
                                    calculator will immediately show you the total amount you will pay to have your
                                    product in
                                    hand.
                                    you can follow the video</p>
                                <a href="stores.php" class="btn-custom">View all stores</a>
                            </li>

                            <li>
                                <h3>Place an ordert</h3>
                                <p>After getting the total price, you click on add to cart button and follow
                                    instruction
                                    to
                                    complete
                                    your order, or follow the video.</p>
                            </li>
